...
class _UserOptionsPageState
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            InputField(
              initialValue: user.nome == null ? "" : user.nome,
              labelText: "Nome",
            ...
            InputField(
                initialValue: user.idade == null ? "" : user.idade.toString(),
                labelText: "Idade",
                inputTextColor: Colors.white,
            ...
            InputField(
              initialValue: user.altura == null ? "" : user.altura.toString(),
              labelText: "Altura",
              suffixText: "cm",
              inputTextColor: Colors.white,
              keyboardType: TextInputType.number,
            ...
            InputField(
              initialValue: user.peso == null ? "" : user.peso.toString(),
              labelText: "Peso",
              inputTextColor: Colors.white,
              suffixText: "kg",
  ...
  Widget _editUserWidget(UserModel user) {
    return Padding(
      padding: const EdgeInsets.all(12.0),
      child: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            InputField(
                initialValue: user.idade.toString(),
                labelText: "Idade",
                inputTextColor: Colors.white,
                keyboardType: TextInputType.number,
                errorText: controller.errorIdade,
            ...
            InputField(
              initialValue: user.peso.toString(),
              labelText: "Peso",
              inputTextColor: Colors.white,
              suffixText: "kg",
              suffixStyle: TextStyle(color: Colors.white, fontSize: 20),
